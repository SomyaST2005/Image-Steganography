# spread_spectrum.py
#
# Security note: The fixed seed (42) makes the spread sequence deterministic.
# XOR with a fixed sequence provides obfuscation, not cryptographic security.
# This is acceptable for visual steganography — the real security comes from
# the Huffman encoding + LSB embedding making the message undetectable.
